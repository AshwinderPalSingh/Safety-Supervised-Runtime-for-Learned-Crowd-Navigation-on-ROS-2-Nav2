...
TEST(LidarTracker, ConsistentMotionProducesVelocityInTheRightDirection)
{
  ...
  LidarTracker tracker(/*gate_distance_m=*/0.6, /*max_misses=*/5, /*velocity_smoothing=*/1.0);
...
{
  LidarTracker tracker(/*gate_distance_m=*/0.6, /*max_misses=*/3, /*velocity_smoothing=*/0.5);
  tracker.update({Detection{0.0, 0.0}}, t(0.0));
...
{
  LidarTracker tracker(/*gate_distance_m=*/0.6, /*max_misses=*/1, /*velocity_smoothing=*/0.5);
  auto obs1 = tracker.update({Detection{0.0, 0.0}}, t(0.0));
  tracker.update({}, t(0.1));  // miss 1
...
{
  LidarTracker tracker(/*gate_distance_m=*/0.3, /*max_misses=*/5, /*velocity_smoothing=*/0.5);
  tracker.update({Detection{0.0, 0.0}}, t(0.0));
